...
public class PinkDialogue : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (bStart == false && MissionAsk == false && bQuest == false)
        {
            bStart = true;
            Name.SetActive(true);
            Name.GetComponent<Text>().text = "핑키";
            index = 0;
        ...
        if (bStart == false && Item.appleNum >= 0 && Item.appleNum < 10 && bQuest == false && MissionAsk == true)
        {
            bStart = true;
            Name.SetActive(true);
            Name.GetComponent<Text>().text = "핑키";
        ...
        if (bStart == false && Item.appleNum >= 10 && bQuest == false && MissionAsk == true)
        {
            bStart = true;
            Name.SetActive(true);
            Name.GetComponent<Text>().text = "핑키";
    ...
    public void NextSentence()
    {
        ...
        if (index < sentences1.Length - 1 && MissionAsk == false && bQuest == false)
        {
            index++;
            Text.GetComponent<Text>().text = "";
            StartCoroutine(Type1());
        ...
        else if (index < sentences2.Length - 1 && Item.appleNum >= 0 && Item.appleNum < 10 && bQuest == false && MissionAsk == true)
        {
            index++;
            Text.GetComponent<Text>().text = "";
            StartCoroutine(Type2());
        ...
        else if (index < sentences3.Length - 1 && Item.appleNum >= 10 && bQuest == false && MissionAsk == true)
        {
            index++;
            Text.GetComponent<Text>().text = "";
            StartCoroutine(Type3());
        ...
        else
        {
            ...
            if (Item.appleNum >= 10 && bQuest == false)
            {
                bQuest = true;
                QuestCom();
            }            
    ...
    public void QuestCom()
    {
        if (bQuest == true)
        {
            ...
            //GameObject.Find("Inventory").GetComponent<InventoryManager>().QuestComplete();
            Inventory.GetComponent<InventoryManager>().QuestComplete();
        }
    }
}
